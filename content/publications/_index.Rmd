...
pubs <- range_read("https://docs.google.com/spreadsheets/d/1EXR666AmWCTuTrifL-BtlwS4BgPs-n3NE0OQkhnAoHc/edit#gid=0", sheet = 1, col_types = c("c"))
      ...
      HTML(
        "<li>
          <div uk-filter='target: .js-filter'>
            <div class='uk-flex-center uk-grid-small uk-child-width-auto' uk-grid>
              <div>
        ...
        "<ul class='js-filter uk-grid-match uk-child-width-1-2@m' uk-grid>",
        ref_data %>%
          mutate(year_arrange = ifelse(year == "in-progress","0",year)) %>% 
          arrange(pub_type,desc(year_arrange),count_auth) %>% 
          glue_data( 
            ...
            "<div class='uk-card-badge uk-label uk-text-small uk-padding-small uk-padding-remove-vertical uk-border-rounded' uk-tooltip='title: {journal}; pos: top'>{abbr}</div>",
