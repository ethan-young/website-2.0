...
timeline.push({
  ...
  pages: [
    ...
    "Please write down all of the original and creative uses for a <b style = 'color: blue;'> paperclip </b> that you can think of.<br><br>"+
    "Certainly, there are common, unoriginal ways to use a paperclip. For this task, write down all of the <b><i> unusual, creative, and uncommon uses </i></b> you can think of.<br><br>" +
...
var aut_paperclip = {
  ...
  preamble: '<img src="img/paperclip.jpeg" height = "300px" ><br> Your responses:<br><br><div style="margin: 10%; line-height: 40px;">',
  questions: [{prompt: 'Type a use here and hit enter to add it:', required: true}],
...
var aut_paperclip_rank = {
    ...
    stimulus: "Pick which three are your most creative ideas. Just click on the three that you think are your best.<br><br>",
    choices: ["none"],
...
var aut_paperclip_rerank = {
  type: 'html-button-response',
  stimulus: "Thanks!<br><br>" + "You chose the following ideas as your three best:<br><br>",
  choices: ['No',"Yes"],
