...
timeline.push({
  ...
  pages: [
    ...
    "Certainly, there are common, unoriginal ways to use a fork. For this task, write down all of the <b><i> unusual, creative, and uncommon uses </i></b> you can think of.<br><br>" +
...
var aut_fork = {
  ...
  preamble: '<img src="img/fork.jpeg" height = "300px"><br> Your responses:<br><br><div style="margin: 10%; line-height: 40px;">',
